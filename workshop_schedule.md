...
### Session 1 — Atul
- Introduction from all participants: background and how they want to use proteomics; introductions (30 min)
...
1. **Farina** — limma/mixed linear modelling design (volcano plot), multiple testing, GSEA, ORA (90 min)
...
1. High-level overview of proteomics
2. Case study on how participants can apply what they learned to a shared project of interest

---

## Day 3 — 1 × 60 min

- Planning and preparing the final presentation
